...
INCLUDE_FLAGS := -ISandbox\Source -IEngine\Source -IEngine\Vendor\GLFW\include -IEngine\Vendor\GLAD\include -IEngine\Vendor\ImGui -IEngine/Vendor/GLM
LINKER_FLAGS := -g -lEngine -lImGui -L$(OBJ_DIR)\engine -L$(BUILD_DIR) #-Wl,-rpath,.
...
link: scaffold $(OBJ_FILES) # link
	...
	@g++ Engine/Vendor/GLAD/build/glad.o $(OBJ_FILES) -o $(BUILD_DIR)\$(ASSEMBLY)$(EXTENSION) $(LINKER_FLAGS)
